...
using couts.
Like mentioned above we made an option so that the user can see a MAZE_XX_WINNER.TXT file in the game, and as the play it will ask for a maze number, it will verify the maze
...
If the player won his time to complete the maze will be displayed in seconds and he will be asked if he wants to save his time in the records (if the answer is no he will be
asked if he wants to play again). If the answer is yes he will be asked for his name (or username if he so wishes).
