...
//robots movement
void robot_move(game_info &gameplay){
 //to be implemented
}
...
void play(int &maze_num,game_info &gameplay) {
    ...
    while(true){
        player_move(gameplay); //to be worked - player movement
        print_maze(gameplay);
        if(gameplay.maze_map[gameplay.player_pos[0]][gameplay.player_pos[1]] == 'h'){
            cout << "You lost!" << endl;
            break;
        }
        robot_move(gameplay);   //not implemented - robots movement
    }
